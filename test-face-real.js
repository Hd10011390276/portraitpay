...
async function main() {
  ...
  const img2 = path.join(tempDir, 'face_real2.jpg');

  console.log(`Image 1: ${fs.statSync(img1).size} bytes`);
  console.log(`Image 2: ${fs.statSync(img2).size} bytes`);
  ...
  console.log('(Two DIFFERENT real face photos - should return LOW similarity or FAIL)');
