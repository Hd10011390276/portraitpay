...
export async function buildCertificateImage(data: CertificateData): Promise<Buffer> {
  ...
  // Early contributor badge text
  const earlyBadge = data.isEarlyContributor
    ? `<text x="655" y="165" text-anchor="middle" font-family="Arial" font-size="10" font-weight="bold" fill="#fbbf24">★ EARLY CONTRIBUTOR ★</text>`
    : '';
...
<svg width="800" height="600" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="70" y="200" font-family="Arial" font-size="18" font-weight="bold" fill="#fbbf24">${data.certificateNo}</text>
