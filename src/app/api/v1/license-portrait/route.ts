    ...
    if (authorizationId) {
      ...
      return NextResponse.json({
        ...
        data: {
          ...
          platformFee: (() => { try { return JSON.parse(auth.terms).platformFee; } catch { return null; } })(),
          actorPayment: (() => { try { return JSON.parse(auth.terms).actorPayment; } catch { return null; } })(),
