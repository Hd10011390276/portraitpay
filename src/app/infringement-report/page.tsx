/**
 * /infringement-report — Public Infringement Report Generator
 *
 * Any person can fill out this form to create an infringement report
 * for AI face clone, voice clone, or AI short drama theft.
 * No login required.
 */
...
function infringementLabel(v: string) {
...
export default function InfringementReportPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    setTimeout(() => {
      setReportNumber(makeReportNumber());
      setSuccess(true);
      setLoading(false);
    }, 800);
  }
  ...
  function buildReportText() {
    const lines = [
      ...
      `Infringement Type: ${infringementLabel(form.infringementType)}`,
        ...
        <main className="max-w-2xl mx-auto px-6 py-12">
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 dark:text-white">{infringementLabel(form.infringementType)}</p>
                </div>
                <div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between mb-3">
              <h2 className="font-semibold text-gray-900 dark:text-white text-sm">Full Report Text</h2>
              <button
                onClick={handleCopy}
      ...
      <main className="max-w-2xl mx-auto px-6 py-10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
            AI face clone or voice clone? Fill out the form below to generate a report you can use to file complaints or报警.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 space-y-6">
          ...
          <p className="text-xs text-center text-gray-400">
            This report is for reference only. No login required. For legal action, consult an attorney.
          </p>
        </form>
      </main>
    </div>
